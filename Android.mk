...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"bts-yeeter"' -DVERSION='"0.2.0"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
